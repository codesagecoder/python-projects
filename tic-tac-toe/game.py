...
class TicTacToe:
    ...
    def available_moves(self):
        ...
        #     # enumerate will create a list of tuples with each iteration
        #     # assigning a int as a index/key
        #     # ['x','o',] --> [(0,'x'),(1,'o')]
        #     if spot == ' ':
        #         moves.append(i)
        # return moves
    ...
    def num_empty_squares(self):
        return len(self.available_moves()) # self.board.count(' ')
