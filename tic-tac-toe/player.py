...
class RandomComputerPlayer(Player):
    ...
    def get_move(self, game):
        # get a random valid spot for our next get_move
...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        while not valid_square:
            ...
            # we're going to check that this is a correct value by trying to cast it
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self,state,player):
        ...
        if player == max_player:
            ...
            best = {'position':None, 'score': math.inf} # each score should minize
        ...
        for possible_move in state.available_moves():
            ...
            sim_score['position'] = possible_move # otherwise this will get messed up from the reccursion
